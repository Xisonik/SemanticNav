...
class Control_module:
    def __init__(self, num_envs, device, scene_manager):
        """
        Args:
    ...
    def get_scene_grid(self, config_key, positions_for_obstacles):
        ...
        self.scene_manager.graphs[0].update_positions(positions_for_obstacles, obstacle_pos)
    ...
    def initialize_configs_and_start_nodes(self):
        ...
        num_obstacles = self.scene_manager.num_obstacles
    ...
    def update(self, current_positions, target_positions, env_ids=None, config_key=None):
        ...
        if config_key is None:
            config_key = ''.join(str(i) for i in range(self.scene_manager.num_obstacles))
