...
# --- настройки путей ---
INPUT_PATH = Path("/home/xiso/IsaacLab/source/isaaclab_tasks/isaaclab_tasks/direct/aloha_turn/scene_items.json")         # исходный JSON
OUTPUT_PATH = Path("/home/xiso/IsaacLab/source/isaaclab_tasks/isaaclab_tasks/direct/aloha_nav/cdecode_dict.json")      # сюда запишется словарь кодов
CLIP_EMB_PATH = Path("/home/xiso/IsaacLab/source/isaaclab_tasks/isaaclab_tasks/direct/aloha_nav/text_embeddings.pt")   # сюда запишем эмбеддинги CLIP
